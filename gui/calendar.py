...
class ClassroomSchedule:
    ...
    def refresh_schedules(self):
        try:
            ...
            schedules_df['start_time'] = pd.to_datetime(schedules_df['start_time'], format="%Y-%m-%d %H:%M:%S", errors='coerce')
            schedules_df['end_time'] = pd.to_datetime(schedules_df['end_time'], format="%Y-%m-%d %H:%M:%S", errors='coerce')
